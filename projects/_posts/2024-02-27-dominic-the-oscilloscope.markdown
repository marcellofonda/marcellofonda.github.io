...
On this crowded breadboard you can distinguish a flipped version of the circuit in the drawing: on row 1 drown their feet `T1` (`a1`) and `Z1` (`j1`); on row 2 there's `T2`... LEDs complete the circuit: I did figure something out in the end. This baby Dominic whose skyline is a promise of short-circuits was the first voltmeter I ever built. And the clumsiest I ever used, for that matter, but that's not the point of it: it worked!
